...
PROTOBUF_NAMESPACE_OPEN
template <>
::test::Person* Arena::CreateMaybeMessage<::test::Person>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace test {
...
class Person final
    : public ::PROTOBUF_NAMESPACE_ID::
          Message /* @@protoc_insertion_point(class_definition:test.Person) */ {
 public:
...
// string name = 1;
inline void Person::clear_name() { name_.ClearToEmpty(); }
inline const std::string& Person::name() const {
  // @@protoc_insertion_point(field_get:test.Person.name)
  return _internal_name();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE void Person::set_name(ArgT0&& arg0,
                                                    ArgT... args) {
...
// int32 age = 2;
inline void Person::clear_age() { age_ = 0; }
inline int32_t Person::_internal_age() const { return age_; }
inline int32_t Person::age() const {
  // @@protoc_insertion_point(field_get:test.Person.age)
  return _internal_age();
}
inline void Person::_internal_set_age(int32_t value) { age_ = value; }
...
// string email = 3;
inline void Person::clear_email() { email_.ClearToEmpty(); }
inline const std::string& Person::email() const {
  // @@protoc_insertion_point(field_get:test.Person.email)
  return _internal_email();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE void Person::set_email(ArgT0&& arg0,
                                                     ArgT... args) {
