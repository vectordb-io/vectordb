#ifndef VECTORDB_MSG_VERSION_REPLY_H_
#define VECTORDB_MSG_VERSION_REPLY_H_
...
class MsgVersionReply;
using MsgVersionReplySPtr = std::shared_ptr<MsgVersionReply>;
using MsgVersionReplyUPtr = std::unique_ptr<MsgVersionReply>;
